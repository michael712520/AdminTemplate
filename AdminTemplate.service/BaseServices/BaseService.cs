...
namespace AdminTemplate.service.BaseServices
{
    ...
    {
        protected daglContext DbContext;
        ...
        protected BaseService()
        {
            ...
            var contextOptions = new DbContextOptionsBuilder<daglContext>().UseMySQL(connectionString).Options;
            DbContext = new daglContext(contextOptions);
